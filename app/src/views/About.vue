    ...
    <div class="grid gap-4 grid-cols-6">
      ...
      <div class="section mt-6 lg:mt-10">
        <h1>Frequently Asked Questions</h1>
         ...
         <p class="mt-6 font-bold">Will this remove the need for documentations and guides?</p>
          <p class="mt-4">
          Not at all! This site is a complement to Google’s official documentation. 
          We hope you’ll find inspiring and useful pieces of code built by developers worldwide.
          </p>
         ...
         <p class="mt-6 font-bold">Why did my submission get rejected?</p>
          ...
          <p class="mt-4">
          The more the merrier. You can make as many submissions as you want. We have no limit to quality content being served on our site. 
          </p>

          <p class="mt-6 font-bold">What is the process of selection/rejection of content?</p>
          <p class="mt-4">
            Once you make the submission of your work (GitHub or Blog), internal Google experts from each product area review it. 
            Check it for quality, freshness, and uniqueness. 
            If it passes all the checks, they select the content to go on the site. You then receive an email about the acceptance of your work. 
          </p>
          ...
          <p class="mt-6 font-bold">
          When will I get updates about the rejection/acceptance of my content?
          </p>
          <p class="mt-4">
           As soon as you submit your content, you receive an email from the Advocu team confirming your submission. 
           Curators generally take 1-2 weeks to curate the content. Once done, you receive an email for the Acceptance/Rejection of your work.
           If you don’t see an email, make sure to check your spam or promotions folder. 
           Also, allowlist DevLibrary emails to refrain from missing out on the updates from the next time onward. 
          </p>
          
          <p class="mt-6 font-bold">
            How long does it take for content to appear on the
            site?
          </p>
          <p class="mt-4">
            Once approved, the content gets on the site within a week of approval. 
          </p>
          ...
          <p class="mt-4">
            What is hard work without any recognition!
            If you become an author at Dev Library, you receive:
            <li>
            <ul> Visibility of your work</ul>
          ...
          <p class="mt-4">
            To remove your content, please raise a Pull Request on the Dev Library’s GitHub repo. 
            In case you are unable to do this, please fill out the
          ...
          <p class="mt-4">
            To raise an issue, please post your issue here on the Dev Library repo.  
            In case you are unable to do this, please fill out the <a href="https://forms.gle/MdMEj7hkdWFLUBrf7" target="blank"> Contact Us form.
          </p>
          <p class="mt-6 font-bold">
